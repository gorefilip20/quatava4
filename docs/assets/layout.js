...
class DocsLayout {
    ...
    setupDefaultNavigation() {
        this.sidebarItems = [
            ...
            },
            {
                title: 'Installation',
                items: [
                    { title: 'Quantava Virtualmin Setup', href: '#virtualmin-setup', icon: '📦' },
    ...
    registerRoutes() {
        ...
        this.routes.set('virtualmin-setup', {
            title: 'Quantava Virtualmin Setup',
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-600 dark:text-zinc-400">Install Quantava on your server using our Virtualmin setup guide or manual installation.</p>
