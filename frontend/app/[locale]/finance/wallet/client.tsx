  ...
  return (
    <div className="mx-auto max-w-[1180px] space-y-5">
      ...
      <section className="grid gap-3 md:grid-cols-3">
        {[
          ["TOTAL BALANCE", isUnavailable ? "—" : "$0.00", isUnavailable ? "Connect database to load" : "Live wallet data"],
          ["SPOT BALANCE", isUnavailable ? "—" : "$0.00", isUnavailable ? "Connect database to load" : "Live wallet data"],
          ["FIAT BALANCE", isUnavailable ? "—" : "$0.00", isUnavailable ? "Connect database to load" : "Live wallet data"],
