...
const initialBots = [
  { name: "Momentum Bot", subtitle: "Trend Following", icon: Sparkles, status: "UNAVAILABLE", returnValue: "—", allocated: "—", winRate: "—", trades: "—", tone: "blue" },
  { name: "Grid Bot", subtitle: "Range Trading", icon: Grid3X3, status: "UNAVAILABLE", returnValue: "—", allocated: "—", winRate: "—", trades: "—", tone: "blue" },
  { name: "DCA Bot", subtitle: "Dollar Cost Average", icon: Bot, status: "UNAVAILABLE", returnValue: "—", allocated: "—", winRate: "—", trades: "—", tone: "slate" },
];
...
export default function AITradingPage() {
  ...
  return (
    <div className="mx-auto max-w-[1180px] space-y-6">
      ...
      <section className="rounded-md border border-[#dfe5ec] bg-white shadow-[0_1px_2px_rgba(15,23,42,0.03)]"><div className="flex items-center justify-between border-b border-[#edf0f4] px-5 py-4"><h2 className="text-sm font-semibold text-[#263548]">AI Performance Summary</h2><span className="text-[10px] text-[#8b96a4]">Live execution data required</span></div><div className="grid gap-5 p-5 sm:grid-cols-3"><div><p className="text-[10px] text-[#8994a0]">TOTAL RETURN</p><p className="mt-1 text-xl font-bold text-[#7c8795]">—</p></div><div><p className="text-[10px] text-[#8994a0]">ACTIVE STRATEGIES</p><p className="mt-1 text-xl font-bold text-[#7c8795]">—</p></div><div><p className="text-[10px] text-[#8994a0]">CAPITAL DEPLOYED</p><p className="mt-1 text-xl font-bold text-[#7c8795]">—</p></div></div></section>
