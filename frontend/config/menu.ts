    ...
    megaMenu: [
      {
        ...
        child: [
          ...
          {
            key: "admin-convert-platform",
            title: "Convert",
            icon: "solar:refresh-circle-bold-duotone",
            permission: "access.convert",
            href: "/admin/convert",
            description:
              "Instant crypto-to-fiat conversion platform with automated bank transfers, competitive rates, and multi-country support.",
          },
        ],
      },
      {
...
export const userMenu: MenuItem[] = [
  {
    ...
    child: [
      ...
      {
        key: "user-trading-convert",
        title: "Convert",
        href: "/convert",
        icon: "solar:refresh-circle-bold-duotone",
        description:
          "Instantly convert cryptocurrency to fiat currency with competitive rates, multiple payment methods, and automated bank transfers.",
      },
    ],
  },
  {
