...
// Try multiple paths for .env file - prioritize explicit DOTENV_CONFIG_PATH and repo root
const envPaths = [
  process.env.DOTENV_CONFIG_PATH,
  path.resolve(process.cwd(), "../.env"), // Repo root when cwd is /backend
  path.resolve(process.cwd(), ".env"),    // Repo root when cwd is project root
